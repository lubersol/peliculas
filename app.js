...
const MongoURI = 'mongodb+srv://lucia:7PciXE9kbyZ76I49@heroku-mongo-mi-atlas.xabhu.mongodb.net/heroku-mongo-atlas?retryWrites=true&w=majority' 
mongoose.connect(MongoURI, { useCreateIndex: true, useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify:false })
    ...
    //|| 'mongodb://localhost:27017/heroku-mongo'
//eac9p1OWTiqifoyj
